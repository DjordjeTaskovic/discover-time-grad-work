...
<script src='{{ asset("assets/dashboard/vendors/scroll/scrollbar.min.js")}}'></script>
<script src="{{ asset("assets/dashboard/js/functions.js")}}"></script>
<script src="{{ asset("assets/dashboard/vendors/chart/chart.min.js")}}"></script>
<script src="{{ asset("assets/dashboard/js/admin.js")}}"></script>
<script src='{{asset ("assets/dashboard/vendors/calendar/moment.min.js")}}'></script>
<script src='{{asset ("assets/dashboard/vendors/calendar/fullcalendar.js")}}'></script>

{{-- <script src="{{asset ("assets/dashboard/vendors/summernote/summernote.js")}}"></script> --}}
{{-- <script src="{{asset ("assets/dashboard/vendors/file-upload/imageuploadify.min.js")}}"></script> --}}
