...
(function ($) {
	...
	var BasicFunction = function () {
		...
		var setBasicCarousel = function () {
			if (!checkSelectorExistence('.basic-carousel')) { return; }
			jQuery('.basic-carousel').owlCarousel({
				...
				navContainer: '.hero-content .hero-nav',
			});
		}
		...
		var setMyCarousel = function () {
			...
			$('.btnJump3').click(function () {
				$('#myCarousel').trigger('to.owl.carousel', 2)
			});
			var incar = $('.in-carousel');
			incar.owlCarousel({
				loop: false,
				margin: 20,
				nav: false,
