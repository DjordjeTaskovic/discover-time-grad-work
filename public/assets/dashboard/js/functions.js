...
(function($) {
		...
		var ThemeBuilder = function(){
				...
				var reviewModal = function() {
					jQuery("#review-modal-btn").on('click',function() {jQuery('#review-bar').fadeIn(500).addClass('On');});
					jQuery("#search-remove").on('click',function() {jQuery('#review-bar').fadeOut(500).removeClass('On');});
				}
